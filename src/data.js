...
export const evidence = [
  ...
  },
  {
    ...
    summary: "A 10.95 MB planner reasons over 70 replaceable public records in this tab.",
    detail:
      "This page runs a distilled six-pass evidence planner through ONNX Runtime WASM. It routes open questions over the public corpus, retrieves evidence, keeps follow-up context, and rejects unsupported or private claims. The release cleared 1,147 fresh validation and hidden cases, including 120 counterfactual pairs, plus 82 real-profile acceptance checks.",
    metric: "10.95 MB · LOCAL",
    secondaryMetric: "82/82 PROFILE CHECKS",
